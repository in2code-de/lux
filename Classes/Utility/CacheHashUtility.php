...
class CacheHashUtility
{
    ...
    protected static array $excludedVariables = [
        'hash', // redirect hash for JavaScript (part of shortener before second redirect)
        'luxContent',
        'lux[doubleoptin][hash]',
        ...
        'tx_lux_fe[arguments][redirectHash]', // redirect hash for shortener redirect
