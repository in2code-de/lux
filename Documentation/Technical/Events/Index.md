...
| CrawlerDetectionService::isCrawler()                  | \In2code\Lux\Events\DetectCrawlerEvent                                    | This event can be used to mark a user agent as crawler (or to allow a user agent that was detected as crawler)                            |
